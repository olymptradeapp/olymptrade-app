                ...
                <nav className="mobile-menu">
                    <ul>
                        <li className="wow animate__animated animate__fadeInLeft " data-wow animate__animated-delay="0.5s">
                            <Link href="https://app.appsflyer.com/com.olymptrade.flex?pid=affiliate&c=2237554&af_siteid=2237554&af_sub2=&af_sub1=">Google Play</Link>
                        </li>
                        <li className="wow animate__animated animate__fadeInLeft " data-wow animate__animated-delay="1s">
                            <Link href="https://app.appsflyer.com/id6476768808?pid=affiliate&c=2237554&af_siteid=2237554&af_sub2=&af_sub1=">App Store</Link>
                        </li>
                    </ul>
                </nav>
            )}
